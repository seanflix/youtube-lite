...
const Videoitem = ({video, onVideoSelect}) => {
  return (
    <div className="bg-white flex sm:flex-col cursor-pointer hover:scale-105 transition-all ease-in-out duration-300 shadow-lg border sm:rounded-2xl sm:overflow-hidden h-28 sm:h-auto" onClick={() => onVideoSelect(video)}>
      <img alt="content" className="aspect-video object-cover" src={video.snippet.thumbnails.medium.url}/>
      <div className="px-5 pt-3 pb-5 overflow-hidden">
        <h2 className="capitalize text-sm sm:text-lg leading-tight font-medium title-font text-gray-800">
